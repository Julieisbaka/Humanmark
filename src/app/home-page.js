	...
	if (changelogEl && changelog?.summary) {
		...
		changelogEl.innerHTML = `
			<article class="panel panel--soft">
				<p class="eyebrow">What's new${generatedAt ? ` · ${generatedAt}` : ''}</p>
				<h2>Weekly changelog</h2>
				<div class="changelog-body">${changelog.summary.replace(/\n/g, '<br>')}</div>
				<p class="eyebrow" style="margin-top:1rem">⚠ This summary was generated by GitHub Copilot (AI) and may not be fully accurate.</p>
			</article>
		`;
	}
