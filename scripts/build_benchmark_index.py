...
BENCHMARK_DEFINITIONS: list[dict[str, Any]] = [
    ...
    },
    {
        "id": "arc_challenge",
        "name": "ARC Challenge",
        "description": "A 4-option science and commonsense benchmark focused on grade-school level challenge questions.",
        "options": 4,
        "scoring": {"method": "pass@1", "mode": "multiple-choice", "options": 4},
        "source": {"dataset": "allenai/ai2_arc", "subset": "ARC-Challenge", "split": "test"},
        "tags": ["science", "commonsense", "4 options"],
        "toolPolicy": {
            "modelToolsAllowed": False,
            "allowedTools": [],
            "notes": "Use the same tool allowance for fair comparison.",
        },
        "generatedQuestionsFile": "arc_challenge.json",
        "file": "arc_challenge.json",
    },
    {
        "id": "mmlu_standard",
        "name": "MMLU (Standard)",
        "description": "A classic 4-option broad knowledge benchmark spanning many academic and professional subjects.",
        "options": 4,
        "scoring": {"method": "pass@1", "mode": "multiple-choice", "options": 4},
        "source": {"dataset": "cais/mmlu", "subset": "all", "split": "test"},
        "tags": ["knowledge", "broad coverage", "4 options"],
        "toolPolicy": {
            "modelToolsAllowed": False,
            "allowedTools": [],
            "notes": "Use the same tool allowance for fair comparison.",
        },
        "generatedQuestionsFile": "mmlu_standard.json",
        "file": "mmlu_standard.json",
    },
    {
        "id": "mmlu_pro",
        "name": "MMLU-Pro",
